...
#-----------------------------------------------------------[Initialize]-----------------------------------------------------------
Clear-Host
$rootFolder = "$PSScriptRoot\ligerasdnnclubes"
...
Delete-FolderContents "bin" `
	-Include "*.xml", 
		...
		"ZeusFrameworkDAL.*", "ZeusTools*",
		"ZeusHoteles.*", "ZeusTecnologia.ZWDomicilios*", "ZeusTecnologia.ZWHoteles*", "ZeusTecnologia.ZWPOS*", "Zeus.InteligEmp.Hoteles",
		# pdb for DNN
