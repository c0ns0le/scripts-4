...
REM si no se pasan parametros, sale
IF NOT DEFINED MYSCRIPT (
	ECHO Terminando. No se debe llamar directamente este script.
	GOTO :EOF
)
...
:EOF
ENDLOCAL
REM Intencionalmente pausar siempre para revisar si hay algun 'WARNING'
PAUSE